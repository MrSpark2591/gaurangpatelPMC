...
function initMonolit() {
  ...
  var vid = $(".background-vmeo").data("vim");
  $(".background-vmeo").append(
    '<iframe src="//player.vmeo.com/video/' +
      vid +
  ...
  if ($(window).width() > 1024) {
    ...
    $(".video-holder").height($(".media-container").height());
    $(".background-vmeo iframe ").height($(".media-container").height());
  } else {
    $(".video-holder").height($(".media-container").height());
    $(".background-vmeo iframe ").height($(".media-container").height());
  }
...
function initparallax() {
  ...
  if (trueMobile) $(".background-youube , .background-vieo").remove();
}
...
var $form = $('form#contact-us'),
  url = 'https://script.google.com/macros/s/AKfycbwbqPfyTx46_oxXpZj4Q9iHKc0kxylSxJk3aZzwp3IlldBSwFRBb_F-sr5PqLLHtaHzOA/exec';
